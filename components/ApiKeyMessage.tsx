...
const ApiKeyMessage: React.FC = () => (
  <div className="w-full max-w-2xl text-center flex flex-col items-center gap-6 p-8 bg-gray-800 border border-red-500/50 rounded-lg animate-[fadeIn_0.5s_ease-out]">
    ...
    <h2 className="text-2xl font-bold text-white">API-Schlüssel nicht konfiguriert</h2>
    <p className="text-gray-300">
      Diese Anwendung benötigt einen Gemini API-Schlüssel, um zu funktionieren.
    </p>
    <p className="text-gray-300">
      Bitte setzen Sie die Umgebungsvariable 
      <code className="bg-gray-700 text-yellow-300 p-1 rounded mx-1 font-mono">API_KEY</code> 
      in Ihrer Hosting-Umgebung (z.B. Vercel) und deployen Sie die Anwendung neu.
    </p>
    <a href="https://vercel.com/docs/projects/environment-variables" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">
      Anleitung: Umgebungsvariablen in Vercel hinzufügen
    </a>
  </div>
);
